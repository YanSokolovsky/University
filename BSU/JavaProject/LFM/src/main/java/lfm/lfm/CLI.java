...
public class CLI extends Thread{
    ...
    ArrayList<String> read(String inputFileName) {
        ...
        if (matcher.find()) {
            XMLReaderNonAPI xmlReader = new XMLReaderNonAPI(currentPath + "\\" + inputFileName);
        ...
        if (matcher.find()) {
            JSONReaderNonAPI jsonReader = new JSONReaderNonAPI(currentPath + "\\" + inputFileName);
    ...
    void write(String outputFileName) {
        ...
        if (matcher.find()) {
            ...
            JSONWriterNonAPI jsonWriter = new JSONWriterNonAPI(currentPath + "\\" + outputFileName);
    ...
    public void run() {
        ...
        while(true) {
            ...
            if (Objects.equals(data[0], "close")) {
                return;
            }
            System.out.println(" ");
        }
